(function() {
	...
	RestHandlers.prototype.addItem = function(object, params, callback) {
		var self = this,
			...
			req = rest.post(apiUrl(object, this.options, true), { json: true, multipart: multipart, data: params, oauthToken: this.options.oauth && this.options.apiToken });
	...
	RestHandlers.prototype.editItem = function(itemId, object, params, callback) {
		var self = this,
			req = rest.put(apiUrl(object + '/' + itemId, this.options, true), { json: true, multipart: false, data: params, oauthToken: this.options.oauth && this.options.apiToken });
	...
	RestHandlers.prototype.removeItem = function(itemId, object, params, callback) {
		var self = this,
			req = rest.del(apiUrl(itemId ? object + '/' + itemId : object, this.options, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { id: itemId }), oauthToken: this.options.oauth && this.options.apiToken });
	...
	RestHandlers.prototype.removeManyItems = function(itemIds, object, params, callback) {
		var self = this,
			req = rest.del(apiUrl(object, this.options, true), { json: true, multipart: false, data: (_.isObject(params) && !_.isFunction(params) ? params : { ids: itemIds }), oauthToken: this.options.oauth && this.options.apiToken });
	...
	RestHandlers.prototype.mergeItem = function(whichId, withId, object, callback) {
		...
		var self = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/merge', this.options, true), { json: true, multipart: false, data: { merge_with_id: withId }, oauthToken: this.options.oauth && this.options.apiToken });
	...
	RestHandlers.prototype.duplicateItem = function(whichId, object, callback) {
		...
		var self = this,
			req = rest.post(apiUrl(object + '/' + whichId + '/duplicate', this.options, true), { json: true, multipart: false, data: {}, oauthToken: this.options.oauth && this.options.apiToken });
